...
peerConnection.onicecandidate = event => {
    event.candidate && 
    receiverRef.child("offerCandidates").push({...event.candidate.toJson(), userId: createdId});
};
...
const createAnswer=async (peerConnection,currentUserId,receiverId) => {
    ...
    peerConnection.onicecandidate = event => {
        event.candidate && 
        receiverRef.child("answerCandidates").push({...event.candidate.toJson(), userId: currentUserId});
    };
